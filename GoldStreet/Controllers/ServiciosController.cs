...
namespace GoldStreet.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ServicioID,NombreServicio")] Servicios servicios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ServicioID,NombreServicio")] Servicios servicios)
        {
            if (ModelState.IsValid)
            {
