...
namespace GoldStreet.Controllers
{
    public class CuentasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CuentaID,ClienteID,FechaApertura")] Cuentas cuentas)
        {
            ...
            ViewBag.ClienteID = new SelectList(db.Clientes, "ClienteID", "Nombre", cuentas.ClienteID);
            return View(cuentas);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CuentaID,ClienteID,FechaApertura")] Cuentas cuentas)
        {
            if (ModelState.IsValid)
            {
